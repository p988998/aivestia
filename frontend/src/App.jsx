...
function ChatPage({ onBack, userId }) {
    ...
    <div className="chat-page">
      <div className="chat-sidebar">
        <div className="sidebar-top">
          ...
          <button className="btn-new-chat" onClick={createNewChat}>+ New Chat</button>
        </div>
            ...
            >
              {editingChatId === chat.id ? (
                <input
                  ...
                  onBlur={() => commitEditTitle(chat.id)}
                ...
                <span
                  ...
                  onDoubleClick={e => startEditTitle(chat, e)}
